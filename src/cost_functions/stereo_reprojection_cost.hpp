...
#include "../sensors/stereo_camera.hpp"

namespace ceres_slam {

//! Stereo reprojection Cost cost function for Ceres with automatic Jacobians
class StereoReprojectionCostAutomatic {
   public:
    //! Camera type
    typedef StereoCamera<double> Camera;

    //! Constructor with fixed model parameters
    StereoReprojectionCostAutomatic(
    ...
    static ceres::CostFunction* Create(
        ...
        return (new ceres::AutoDiffCostFunction<
                ...
                (new StereoReprojectionCostAutomatic(camera, observation,
                                                     stiffness)));
    }
