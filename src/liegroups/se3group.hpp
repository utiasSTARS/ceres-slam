...
class SE3GroupBase {
   public:
    ...
    //! Vector type
    typedef Eigen::Matrix<Scalar, dim - 1, 1> Vector;
    //! Rotation type
    ...
    //! Transform a 3-vector like a homogeneous point with scale 1.
    /*!
    ...
    */
    inline const Vector transform(
        ...
        Vector v_transformed = this->rotation() * v + this->translation();
